    ...
    public class ChangePassword: ContentPage{
        ...
        public ChangePassword()
        {
            ...
            var reset = new Button()
            {
				...
				TextColor = Color.White,
                HorizontalOptions = LayoutOptions.FillAndExpand,
                Command = new Command(() => Reset_Clicked(oldPswd.Text, newPswd.Text, confirmPswd.Text))
            };
        ...
        private void Reset_Clicked(String oldPass, String newPass, String confirmPass)
        {
