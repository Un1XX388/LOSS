...
namespace LOSSPortable{
	public class ReportMessage : ContentPage{
		public ReportMessage(Message msg){
			...
			store.Clicked			+= async delegate{
				await Store("12345", ab);
			};
			load.Clicked			+= async delegate{
				Message ab2				= await Get("12345");
				DisplayAlert(ab2.getId(), ab2.getMessage(), "ok");
			};
	...
	}// End of ReportMessage class.
}// End of namespace LOSSPortable.